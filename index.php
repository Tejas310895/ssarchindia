     ...
     <div class="swiper-container">
         <div class="swiper-wrapper">
             <div class="swiper-slide">
                 <a href="assets/images/renders/BS1.png" data-fancybox="gallery">
                     <div class="image" style="background-image: url(assets/images/renders/BS1.png)">
                         <div class="overlay">
             ...
             <div class="swiper-slide">
                 <a href="assets/images/renders/BS2.jpeg" data-fancybox="gallery">
                     <div class="image" style="background-image: url(assets/images/renders/BS2.jpeg)">
                         <div class="overlay">
                             <em class="mdi mdi-magnify-plus"></em>
                         </div>
                     </div>
             ...
             <div class="swiper-slide">
                 <a href="assets/images/renders/BS3.png" data-fancybox="gallery">
                     <div class="image" style="background-image: url(assets/images/renders/BS3.png)">
                         <div class="overlay">
                             <em class="mdi mdi-magnify-plus"></em>
                         </div>
                     </div>
             ...
             <div class="swiper-slide">
                 <a href="assets/images/renders/BS4.jpeg" data-fancybox="gallery">
                     <div class="image" style="background-image: url(assets/images/renders/BS4.jpeg)">
                         <div class="overlay">
                             <em class="mdi mdi-magnify-plus"></em>
                         </div>
                     </div>
             ...
             <div class="swiper-slide">
                 <a href="assets/images/renders/BS5.png" data-fancybox="gallery">
                     <div class="image" style="background-image: url(assets/images/renders/BS5.png)">
                         <div class="overlay">
                             <em class="mdi mdi-magnify-plus"></em>
                         </div>
                     </div>
             ...
             <div class="swiper-slide">
                 <a href="assets/images/renders/BS6.png" data-fancybox="gallery">
                     <div class="image" style="background-image: url(assets/images/renders/BS6.png)">
                         <div class="overlay">
                             <em class="mdi mdi-magnify-plus"></em>
                         </div>
                     </div>
